...
export const GENERATED_BUNDLED_PLUGIN_METADATA = [
  ...
  },
  {
    ...
    packageDescription: "openclaw WeChat channel plugin (via wechat-robot-admin-backend)",
    packageManifest: {
      extensions: ["./index.ts"],
      channel: {
        id: "wechat",
  ...
  },
  {
    ...
    packageName: "@openclaw/wechat-ipad",
    packageVersion: "2026.3.7",
    packageDescription: "OpenClaw WeChat iPad channel plugin (HTTP bridge)",
    packageManifest: {
      extensions: ["./index.ts"],
      channel: {
        id: "wechat-ipad",
        ...
        blurb: "Bridge WeChat iPad via an external HTTP service.",
        aliases: ["wxipad", "wechatipad"],
        order: 86,
        quickstartAllowFrom: true,
      },
      install: {
        npmSpec: "@openclaw/wechat-ipad",
        localPath: "extensions/wechat-ipad",
        defaultChoice: "npm",
      },
    },
    manifest: {
  ...
  {
    dirName: "workspace-editor",
    idHint: "workspace-editor",
    source: {
      source: "./index.ts",
      built: "index.js",
    },
    packageName: "@openclaw/workspace-editor",
    packageVersion: "0.1.0",
    packageDescription:
      "Gateway RPC methods for reading and writing workspace files (SOUL.md, IDENTITY.md, etc.)",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
