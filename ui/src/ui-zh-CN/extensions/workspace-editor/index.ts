...
const plugin = {
  ...
  register(api: MoltbotPluginApi) {
    ...
    api.registerGatewayMethod("workspace.files.list", async ({ params, respond }) => {
      try {
    ...
    api.registerGatewayMethod("workspace.file.read", async ({ params, respond }) => {
    ...
    api.registerGatewayMethod("workspace.file.write", async ({ params, respond }) => {
      // 验证必需的 fileName 参数 / Validate required fileName parameter
      const fileName = typeof params.fileName === "string" ? params.fileName.trim() : "";
      if (!fileName) {
        respond(false, undefined, {
      ...
      try {
        ...
        const agentId =
          typeof params.agentId === "string" ? params.agentId.trim() || undefined : undefined;
        const result = await writeWorkspaceFile(api.config, fileName, content, agentId);
        respond(true, result, undefined);
      } catch (err) {
        respond(false, undefined, {
          code: "WORKSPACE_ERROR",
    ...
    api.registerGatewayMethod("skills.file.read", async ({ params, respond }) => {
      ...
      try {
        ...
        const agentId =
          typeof params.agentId === "string" ? params.agentId.trim() || undefined : undefined;
        const result = await readSkillFile(api.config, skillName, source, agentId, filePath);
        respond(true, result, undefined);
      } catch (err) {
        respond(false, undefined, {
          code: "SKILLS_ERROR",
    ...
    api.registerGatewayMethod("skills.file.write", async ({ params, respond }) => {
      ...
      try {
        ...
        const agentId =
          typeof params.agentId === "string" ? params.agentId.trim() || undefined : undefined;
        const result = await writeSkillFile(api.config, skillName, content, source, agentId);
        respond(true, result, undefined);
      } catch (err) {
        respond(false, undefined, {
          code: "SKILLS_ERROR",
    ...
    api.registerGatewayMethod("skills.file.create", async ({ params, respond }) => {
      ...
      try {
        ...
        const agentId =
          typeof params.agentId === "string" ? params.agentId.trim() || undefined : undefined;
        const result = await createSkill(api.config, skillName, source, content, agentId);
        respond(true, result, undefined);
      } catch (err) {
        respond(false, undefined, {
          code: "SKILLS_ERROR",
    ...
    api.registerGatewayMethod("skills.file.delete", async ({ params, respond }) => {
      ...
      try {
        ...
        const agentId =
          typeof params.agentId === "string" ? params.agentId.trim() || undefined : undefined;
        const result = await deleteSkill(api.config, skillName, source, agentId);
        respond(true, result, undefined);
      } catch (err) {
        respond(false, undefined, {
          code: "SKILLS_ERROR",
