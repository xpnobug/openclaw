  ...
  },
  {
    ...
    configFields: [
      ...
      },
      {
        ...
        label: "API Token",
        type: "password",
        placeholder: "Bearer Token，用于桥接服务鉴权",
        section: "api",
        description: "桥接服务的 API Token，请求头中使用 Authorization: Bearer <token> 传递。",
      },
      {
        key: "tokenFile",
        label: "Token 文件路径",
        ...
        section: "api",
        description: "Token 文件路径，与 API Token 二选一。文件内容将作为 Bearer Token 使用。",
      },
      {
        key: "wxid",
        label: "登录账号 wxid",
      ...
      {
        key: "inbound.webhook.dedupeWindowMs",
      ...
      {
        key: "inbound.webhook.rateLimitPerMinute",
